(function () {
  ...
  const WeightService = {
    ...
    getWeightUnit: function (product) {
      try {
        ...
        // انتظر siteSettings لو لم يكن جاهزًا
    ...
    loadSettings: async function () {
      ...
      // انتظر تحميل siteSettings ثم تحديث من Firestore
      try {
        // إذا لم يكن siteSettings جاهزًا، انتظر قليلاً
        let attempts = 0;
  ...
  // تحميل الإعدادات تلقائيًا عند تحميل الصفحة
