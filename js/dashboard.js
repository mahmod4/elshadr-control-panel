 ...
 * ========================================
 * 
 * Purpose: عرض إحصائيات ونظرة عامة عن أداء المتجر
 * Usage: الصفحة الرئيسية في لوحة التحكم للمسؤولين
 * Features: إحصائيات حية، رسوم بيانية، إشعارات فورية
 * 
 * يحتوي هذا الملف على:
 * - عرض إحصائيات المبيعات اليومية والشهرية
 * - عدد الطلبات والمستخدمين النشطين
 * - عرض أحدث الطلبات وحالتها
 * - إشعارات سريعة عن الأنشطة المهمة
 * - رسوم بيانية تفاعلية للأداء
 * - نظرة عامة عن حالة المتجر
 * 
 * الإحصائيات المعروضة:
 * - مبيعات اليوم والشهر الحالي
 * - إجمالي عدد الطلبات
 * - عدد المستخدمين المسجلين
 * - عدد المنتجات النشطة
 * - أحدث الطلبات مع تفاصيلها
 * - المنتجات الأكثر مبيعاً
 * - الإشعارات والتنبيهات الهامة
 * 
 * الوظائف الرئيسية:
 * - loadDashboard(): تحميل واجهة لوحة التحكم
 * - getDashboardStats(): جلب الإحصائيات
 * - getRecentOrders(): جلب أحدث الطلبات
 * - getNotifications(): جلب الإشعارات
 * - refreshStats(): تحديث الإحصائيات
 * 
 * Dependencies:
 * - Firebase Firestore لجلب البيانات
